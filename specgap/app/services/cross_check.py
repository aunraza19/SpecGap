...
async def run_cross_check(
    ...
    """
    ENGINE D: The Agentic Orchestrator.
    Synthesizes identifying information from previous agents (Tech & Legal) 
    to create a unified 'Master Plan' and Visual Reality Check.
    """
    
    # We construct a multi-part prompt. 
    # If a diagram is provided, we send it as an image part to Gemini Vision.
    ...
    # Add Agent Findings (The Context)
    if tech_report:
    ...
    try:
        # Use the Vision model since we might have an image
